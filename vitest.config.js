...
//    `npm test`: the inner loop while writing code, and the deploy smoke.
...
// Rationale: a long-lived project accumulates hundreds of specs. Running the slow disk/spawn tier on every
