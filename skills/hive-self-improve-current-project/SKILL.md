...
2. **Every surviving finding becomes a ticket at the LIGHTEST defensible verification tier, with
   ...
   see this project's verification-tier rubric; the `tdd` tier it once described is retired
   (TASK-212, 2026-08-13 human decision). The concrete evidence from rule 1 is what makes the
   ticket actionable rather than a vague "clean this up."
