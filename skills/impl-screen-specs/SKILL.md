...
description: Generate the SCREEN_SPECS manifest — a per-screen specification (components, data, API calls, user actions, states, i18n). Optional tool a developer may use anytime to blueprint screens; not required before code (TASK-230, 2026-09-16 human decision). Vendored Spine skill; see src/manifest-policy.js.
---
