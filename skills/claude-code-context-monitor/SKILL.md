...
| Stop                | Claude finishes a turn          | Yes (exit 2)| No                 | No — inherited from §7, never independently verified; `claude doctor` accepting a matcher on Stop neither confirms nor rules out actual support |
