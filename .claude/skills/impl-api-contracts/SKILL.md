...
description: Generate the API_CONTRACTS manifest — an endpoint table by module (method, path, auth, request/response shapes, cache keys, invalidation). Optional tool a developer may use anytime when implementing endpoints or data fetching; not required before code (TASK-230, 2026-09-16 human decision). Vendored Spine skill; see src/manifest-policy.js.
---
