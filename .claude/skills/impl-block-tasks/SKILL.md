...
description: Generate the BLOCK_TASKS manifest — every work block broken into concrete developer tasks with testable + observable acceptance criteria, dependencies, and blocking gaps. Optional tool a developer may use anytime when decomposing an epic/block into tickets; not required before code (TASK-230, 2026-09-16 human decision). Vendored Spine skill; see src/manifest-policy.js.
---
